        ...
        <div class="row">
            <div class="col col-xs-12">
                <div class="gallery-container gallery-fancybox masonry-gallery">
                    ...
                    <script type="text/javascript">
                        photoGalleries.push({
                            src : "{{ asset('images/TNQ05996.JPG') }}",
                            thumb: "{{ asset('images/TNQ05996.JPG') }}",
                    ...
                    <div class="grid grid-item btn-see-more-gallery" data-index="2">
                        <img src="{{ asset('images/TNQ05996.JPG') }}" alt class="img img-responsive">
                    </div>
                   <script type="text/javascript">
                        photoGalleries.push({
                            src : "{{ asset('images/TNQ06146.JPG') }}",
                            thumb: "{{ asset('images/TNQ06146.JPG') }}",
                    ...
                    <div class="grid grid-item btn-see-more-gallery" data-index="3">
                        <img src="{{ asset('images/TNQ06146.JPG') }}" alt class="img img-responsive">
                    </div>
                    <script type="text/javascript">
                        photoGalleries.push({
                            src : "{{ asset('images/TNQ06537.JPG') }}",
                            thumb: "{{ asset('images/TNQ06537.JPG') }}",
                    ...
                    <div class="grid grid-item btn-see-more-gallery" data-index="4">
                        <img src="{{ asset('images/TNQ06537.JPG') }}" alt class="img img-responsive">
                    </div>
                     <script type="text/javascript">
                        photoGalleries.push({
                            src : "{{ asset('images/TNQ06565.JPG') }}",
                            thumb: "{{ asset('images/TNQ06565.JPG') }}",
                    ...
                    <div class="grid grid-item btn-see-more-gallery" data-index="5">
                        <img src="{{ asset('images/TNQ06565.JPG') }}" alt class="img img-responsive">
                    </div>
                    <script type="text/javascript">
                        photoGalleries.push({
